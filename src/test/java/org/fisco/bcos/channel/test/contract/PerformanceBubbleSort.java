...
public class PerformanceBubbleSort {
    private static Logger logger = LoggerFactory.getLogger(PerformanceBubbleSort.class);
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            System.out.println("Deploying BubbleSort contract...");
            BubbleSort bubbleSort = BubbleSort.deploy(web3, credentials, gasPrice, gasLimit).send();
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    bubbleSort.sort(sortedSize, callback);
                                } catch (Exception e) {
