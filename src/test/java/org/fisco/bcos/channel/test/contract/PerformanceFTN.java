...
public class PerformanceFTN {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            System.out.println("Start FTN test...");
            System.out.println(
                    "===================================================================");
            ...
            System.out.println("Deploying FTN contract...");
            FTN ftn = FTN.deploy(web3, credentials, gasPrice, gasLimit).send();
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    ftn.transfer(to, value, callback);
                                } catch (Exception e) {
