...
public class PerformanceOk2 {
    private static Logger logger = LoggerFactory.getLogger(PerformanceOk2.class);
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            Ok2 ok = Ok2.deploy(web3, credentials, gasPrice, gasLimit).send();
