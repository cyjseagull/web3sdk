...
public class PerformanceTestMulti {
    private static Logger logger = LoggerFactory.getLogger(PerformanceTestMulti.class);
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            TestMultiEntry ok = TestMultiEntry.deploy(web3, credentials, gasPrice, gasLimit).send();
