...
public class PerformanceBaseContract {
    private static Logger logger = LoggerFactory.getLogger(PerformanceBaseContract.class);
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            BasePermissionContract ok = BasePermissionContract.deploy(web3, credentials, gasPrice, gasLimit).send();
                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    ok.addPermission(to, valueStr, callback);
                                } catch (Exception e) {
